  ...
  return (
    ...
    <div className="group bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 hover:shadow-lg transition-shadow border border-gray-200 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between lg:flex-row items-center gap-1 lg:gap-3 mb-1">
          <div className=''>
          ...
          <div className="flex gap-1 mt-2 flex-col lg:opacity-0 group-hover:opacity-100 transition-opacity items-baseline">
            <button onClick={() => onEdit(reservable)} className="text-sm font-bold text-blue-500 hover:text-blue-700"><span className="text-left block text-center">編集</span><span className="text-xs text-left block text-center">Edit</span></button>
            <button onClick={() => onDelete(reservable.id)} className="text-sm font-bold text-red-400 hover:text-red-600"><span className="text-left block text-center">削除</span><span className="text-xs text-left block text-center">Delete</span></button>
          </div>
        </div>
